# Program Name: ad-temp-fit.R
# Author: Jacob Englert
# Date: 11AUG2023
# Description: Fit CL-BART models to CA AD data using average temperature as exposure
...
if(!dir.exists(here::here('Results','Temperature','temp'))) dir.create(here::here('Results','Temperature','temp'))
write_rds(fit, here::here('Results','Temperature','temp', paste0(sprintf("%04d", index), ".rds")))
